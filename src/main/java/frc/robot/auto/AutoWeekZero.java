...
public class AutoWeekZero {
  ...
  public static Command sweep(boolean isLeft) {
    ...
    return Commands.sequence(
            //        Commands.parallel(
            //                Commands.sequence(
            //                    Commands.waitSeconds(2), new
            // IntakeAutoCommand(Intake.getInstance())),
            //                new ShakeCommand(OverBumper.getInstance()),
            //                Shooter.getInstance().autoAimCommandAuto())
            //            .withTimeout(5.0),
            ...
            Commands.parallel(
                    new IntakeAutoCommand(
                        Intake
                            .getInstance()), // run the "intake," which pushes balls tot he shooter
                    new ShakeCommand(
  ...
  public static Command climbLeft() {
    ...
    return Commands.sequence(
            ...
            new BetterSmoothMoveCommand(
                    new Pose2d(1.054d, 4.469d, Rotation2d.fromDegrees(0.11d)), false)
                .withAccelerationLimit(aLimit)
                .withVelocityLimit(vLimit)
                .withTimeout(6.0),
  ...
  public static Command climbRight() {
    ...
    return Commands.sequence(
            ...
            Commands.deadline(
                ...
                new BetterSmoothMoveCommand(
                        new Pose2d(1.087d, 2.5d, Rotation2d.fromDegrees(-178.1d)), false)
                    .withAccelerationLimit(aLimit)
                    .withVelocityLimit(vLimit)
                    .withTimeout(0.5d),
                Shooter.getInstance().autoAimCommandAutoDryish()),
                ...
                Commands.sequence(
                    Commands.deadline(
                        Commands.parallel(
                                new IntakeAutoCommand(
                                    Intake
                                        .getInstance()), // run the "intake," which pushes balls tot
                                // he shooter
                                new ShakeCommand(
                                    OverBumper
                                        .getInstance()), // shake the overbumper to dislodge balls
                                Shooter.getInstance()
                                    .autoAimCommandAuto()) // also autoaim and shoot at the same
                            // time
                            .withTimeout(4.0),
                    ...
                    // move to approach position to climb
                    new BetterSmoothMoveCommand(
                            new Pose2d(1.017d, 2.8d, Rotation2d.fromDegrees(-178.1d)), false)
                        .withAccelerationLimit(aLimit)
            ...
            Commands.parallel(
                ...
                Commands.sequence(
                    // approach tower
                    new BetterSmoothMoveCommand(
                            new Pose2d(1.077d, 3.254d, Rotation2d.fromDegrees(-178.1d)), false)
                        .withAccelerationLimit(1)
