...
public class ShooterIOSpark implements ShooterIO {
    ...
    public ShooterIOSpark() {
        ...
        linearActuator.setBoundsMicroseconds(2000, 1800, 1500, 1200, 1200);
...
//        tiltMotor.getEncoder().setPosition(0);
        ...
        flywheelConfig.closedLoop.feedForward.kV(.0015);
        ...
        flywheel2Config.closedLoop.feedForward.kV(.0015);
...
//        inputs.turretPitchRadians = tiltMotor.getAbsoluteEncoder().getPosition();
    ...
    public void setFlywheelVelocity(double speedRotationsPerMinute) {
        flywheelMotor.getClosedLoopController().setSetpoint(speedRotationsPerMinute, ControlType.kVelocity, ClosedLoopSlot.kSlot0);
        flywheelMotor2.getClosedLoopController().setSetpoint(speedRotationsPerMinute, ControlType.kVelocity, ClosedLoopSlot.kSlot0);
    }
