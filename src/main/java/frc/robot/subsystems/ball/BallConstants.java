...
public class BallConstants {
  ...
  public static final double intakeSpeedIntaking = 1.0;
  public static final double indexerSpeedIntaking = -0.25;
  public static final double beltSpeedIntaking = 0.5;
}
