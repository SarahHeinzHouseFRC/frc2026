...
public class Simulator {
  ...
  public void shootBallFromPosition(
      Pose3d positionPose, double pitchAngle, double yawAngle, double velocity) {
  ...
  protected void run() {
    ...
    while (true) {
      ...
      if (elapsed > LOOP_NS) {
        System.out.printf(
            "WARNING: Simulator took too long to run a cycle: %.3f ms\n", elapsed / 1_000_000.0);
      }
